...
public class RessourceController {
    ...
    public ResponseEntity<String> ajouterRessource(@RequestBody Ressource ressource, @PathVariable Long idTache){
        try {
    ...
    public List<Ressource> showsRessourcesByTache(@RequestParam Long idTache){
        return ressourceService.getRessourcesByTache(idTache);
    }

    @PutMapping("/update/{idRessource}")
    public ResponseEntity<Void> modifierRessource(@PathVariable Long idRessource, @RequestBody Ressource ressource){
